...
// configuration step. It creates a namespace called `vulkan_journey`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", vulkan_journey::cmake::project_name, vulkan_journey::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", vulkan_journey::cmake::project_version);
      return EXIT_SUCCESS;
    }
